...
def test_irc_test_era_network_migrates_to_deepflux():
    """Saved networks still carrying the old '#deepflux-test' default channel are
    upgraded in place: test channel swapped for #DeepFlux, auto-connect turned on."""
    import os
    import tempfile
