...
# Browser reads (tab list, live DOM, bookmarks) and download-queue reads.
...
room, and the dual-pane file manager.
...
HLS/DASH streams, YouTube), browse the web, join the community room, manage
files, find subtitles, and set the app up (add IPTV playlist sources, RSS feeds, API keys,
