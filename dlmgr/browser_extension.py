...
(function() {
  ...
  function updateStatusBadge() {
    ...
    if (detectedVideos.length > 0 && apiConnected) {
      statusBadge.style.borderColor = '#a8edff';
      statusBadge.style.color = '#a8edff';
  ...
  function openDownloadMenu() {
    ...
    if (apiConnected === false) {
      ...
      detectedVideos.forEach(function(video, i) {
        ...
        playBtn.style.cssText = 'flex-shrink: 0; background: transparent; color: #a8edff; border: 3px solid #a8edff; border-radius: 4px; padding: 4px 10px; font-size: 18px; font-weight: 600; cursor: pointer;';
